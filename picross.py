...
row_1 = Or(And(puzzle[1][0], puzzle[1][1], Not(puzzle[1][2])),
           And(Not(puzzle[1][0]), puzzle[1][1], puzzle[1][2]))
...
col_0 = Or(And(puzzle[0][0], puzzle[1][0], Not(puzzle[2][0])),
           And(Not(puzzle[0][0]), puzzle[1][0], puzzle[2][0]))
